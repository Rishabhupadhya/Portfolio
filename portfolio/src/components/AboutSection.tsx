  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mb-20"
      >
        <p className="text-sm uppercase tracking-widest text-[#00BFFF] mb-3">
          About Me
        </p>

        <h2 className="text-4xl md:text-5xl font-bold leading-tight">
          Building Production-Ready Systems <br className="hidden md:block" />
          with <span className="text-[#00BFFF]">Cloud, DevOps & AI</span>
        </h2>
      </motion.div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6">
              {skills.map(({ name, icon: Icon }) => (
                ...
                >
                  <Icon
                    size={36}
                    className="text-gray-500 group-hover:text-[#00BFFF] transition-colors"
                  />
                  <span className="text-sm text-gray-600 group-hover:text-[#00BFFF] transition-colors">
                    {name}
                  </span>
                </div>
              ))}
