      ...
      <header className="fixed top-0 left-0 w-full z-50
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a href="#top" className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-[#00BFFF] dark:text-[#00BFFF]">
              Rishabh Upadhyay
            </span>
          </a>
...
<a
  ...
  className={`transition-colors ${
    active === sec
      ...
      : "text-gray-600 dark:text-gray-400 hover:text-[#00BFFF] dark:hover:text-[#00BFFF]"
  }`}
>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="hidden md:inline-flex px-4 py-2 text-sm font-medium
                         border border-blue-600 text-[#00BFFF] dark:text-[#00BFFF]
