  ...
  return (
    <section className="min-h-screen px-6 pt-32 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          <h1 className="mb-6">
            <span className="block text-4xl md:text-6xl font-bold text-[#00BFFF]">
              Rishabh Upadhyay
            </span>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="px-6 py-3 border border-gray-400 dark:border-gray-600
                         ...
                         hover:border-blue-600 hover:text-[#00BFFF]
                         dark:hover:border-blue-500 dark:hover:text-[#00BFFF]"
            >
              Download Resume
            </a>
